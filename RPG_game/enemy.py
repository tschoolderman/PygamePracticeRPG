...
class Enemy(Entity):
    ...
    def __init__(
        self, monster_name, pos, groups, obstacle_sprites, damage_player
    ) -> None:
        # General setup
    ...
    def get_player_distance_direction(self, player):
        """Get the distance between player and monster and player direction."""
    ...
    def get_status(self, player):
        ...
        if distance <= self.attack_radius and self.can_attack:
            # without this the frames skip to 3 or 4
